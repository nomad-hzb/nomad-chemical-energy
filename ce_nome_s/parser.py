...
from ce_nome_s import (CE_NOME_Chronoamperometry, CE_NOME_CyclicVoltammetry, CE_NOME_Chronopotentiometry,
...
class GamryParser(MatchingParser):
    ...
    def parse(self, mainfile: str, archive: EntryArchive, logger):
        ...
        # parser.
        from .file_parser.gamry_parser import get_header_and_data
