    ...
    dashboard=Dashboard(
        widgets=[
            ...
            WidgetHistogram(
                ...
                layout={
                    'xxl': Layout(minH=3, minW=3, h=3, w=12, y=9, x=12),
                    'xl': Layout(minH=3, minW=3, h=3, w=12, y=9, x=12),
                    'lg': Layout(minH=3, minW=3, h=3, w=12, y=9, x=12),
                    'md': Layout(minH=3, minW=3, h=3, w=12, y=0, x=12),
                    'sm': Layout(minH=3, minW=3, h=3, w=12, y=0, x=12),
                },
            ),
            WidgetHistogram(
                ...
                layout={
                    'xxl': Layout(minH=3, minW=3, h=3, w=12, y=12, x=12),
                    'xl': Layout(minH=3, minW=3, h=3, w=12, y=12, x=12),
                    'lg': Layout(minH=3, minW=3, h=3, w=12, y=12, x=12),
                    'md': Layout(minH=3, minW=3, h=3, w=12, y=3, x=12),
                    'sm': Layout(minH=3, minW=3, h=3, w=12, y=3, x=12),
                },
            ),
            WidgetTerms(
                title='Reaction Type',
                layout={
                    'xxl': Layout(minH=3, minW=3, h=6, w=6, y=15, x=0),
                    'xl': Layout(minH=3, minW=3, h=6, w=6, y=15, x=0),
                    'lg': Layout(minH=3, minW=3, h=6, w=6, y=15, x=0),
                    'md': Layout(minH=3, minW=3, h=6, w=6, y=6, x=12),
                    'sm': Layout(minH=3, minW=3, h=6, w=6, y=6, x=12),
                },
            ...
            WidgetTerms(
                title='Author Name',
                layout={
                    'xxl': Layout(minH=3, minW=3, h=6, w=6, y=21, x=0),
                    'xl': Layout(minH=3, minW=3, h=6, w=6, y=21, x=0),
            ...
            WidgetHistogram(
                ...
                layout={
                    'xxl': Layout(minH=3, minW=3, h=6, w=12, y=21, x=6),
                    'xl': Layout(minH=3, minW=3, h=6, w=12, y=21, x=6),
            ...
            WidgetScatterPlot(
                ...
                autorange=True,
                x=Axis(
                    search_quantity=f'data.outputs.charge_density#{schema}',
                    unit='mC/cm**2',
                    scale='linear',
                ),
                y=Axis(
                ...
                layout={
                    'xxl': Layout(minH=3, minW=3, h=6, w=6, y=27, x=0),
                    'xl': Layout(minH=3, minW=3, h=6, w=6, y=27, x=0),
                    'lg': Layout(minH=3, minW=3, h=6, w=6, y=27, x=0),
                    'md': Layout(minH=3, minW=3, h=8, w=8, y=12, x=12),
                    'sm': Layout(minH=3, minW=3, h=8, w=8, y=12, x=12),
                },
            ),
        ]
    ),
