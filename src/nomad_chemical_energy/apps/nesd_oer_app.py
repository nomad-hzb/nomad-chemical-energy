        ...
        widgets=[
            ...
            WidgetTerms(
                ...
                layout={
                    ...
                    'md': Layout(minH=3, minW=3, h=5, w=6, y=15, x=0),
                    'sm': Layout(minH=3, minW=3, h=5, w=6, y=15, x=0),
                },
            ...
            WidgetHistogram(
                ...
                layout={
                    ...
                    'md': Layout(minH=3, minW=3, h=6, w=6, y=21, x=6),
                    'sm': Layout(minH=3, minW=3, h=6, w=6, y=21, x=6),
                },
            ),
        ]
    ),
